...
def run_mesma_for_image(image,spectral_library):                                                                                                                                               
...
def run_mesma(s3_bucket:str = None, s3_folder:str = None, image_files: List[str] = None):
    ...
    download_tif_image(s3_bucket, s3_folder, image_files, image_folder, temp_creds)
    for image in image_files:
        image_path = "/tmp/"+image
        spectral_library = "/workspace/library/38_output.sli"
        run_mesma_for_image(image_path,spectral_library)
